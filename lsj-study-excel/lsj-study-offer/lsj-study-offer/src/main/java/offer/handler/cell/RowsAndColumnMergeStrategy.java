 ...
 */
public class RowsAndColumnMergeStrategy extends AbstractMergeStrategy {
    /**
     * 合并坐标集合.
     */
     ...
     * .
     */
    public RowsAndColumnMergeStrategy() {
    }

    public RowsAndColumnMergeStrategy(int startRowIndex, List<CellRangeAddress> cellRangeAddresses) {
